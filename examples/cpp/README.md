...
an adjacent pane. The UI shows the Geometer version string and C ABI generation
at the top of the window. The app requests a high-pixel-density SDL window and
scales Dear ImGui's font/style from `SDL_GetWindowDisplayScale()` at startup.
