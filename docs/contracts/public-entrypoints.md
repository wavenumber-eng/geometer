...
| Mesh illustration | Browser renderer; unreleased direct C++ `mesh_illustration.h` and `geometry.mesh_illustration.a0` native operation | Browser exports and development typed Rust/Python executable methods | Existing generated A0 input/style/result reused; additive generated settings plus mesh attachment. Optional native HLR composition remains separate work. See [native boundary](../design/mesh-illustration-native.md). |
