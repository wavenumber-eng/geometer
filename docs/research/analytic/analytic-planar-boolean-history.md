# Historical Analytic Solver Design And Evidence

This is the pre-cleanup mixed design/evidence record, archived 2026-09-05.
It is not current production guidance. The [maintained logical contract](../../design/analytic-planar-boolean-a0.md)
and ADR-017 control current interface semantics and experimental maturity.
Historical references to production or MATZ gates do not reopen that effort.
