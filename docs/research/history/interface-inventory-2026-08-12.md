# Historical Interface Inventory Snapshot

Historical pre-IPC TypeSpec-program snapshot, retained as evidence. Some version
labels were refreshed before archival; its absence/handwritten claims describe
the original 2026-08-12 audit, not current runtime behavior. Use the
[maintained inventory](../../contracts/current-interface-inventory.md) instead.
