import type { ArcDirection } from "@wavenumber/geometer";

export interface ReflectedCanvasArc {
...
export function resolveReflectedCanvasArc(
  startX: number,
  startY: number,
  endX: number,
  endY: number,
