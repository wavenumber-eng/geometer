...
| Artifact | Role | Notes |
|---|---|---|
| `native/<platform>/geometer(.exe)` | Native CLI | Command-line STEP/HLR/planar tool for source checkouts. Current platform names use `windows-x64`, `linux-x64`, `macos-x64`, and `macos-arm64`. |
