...
The [frozen original report](geom-a0-contract-alignment-frozen.txt) preserves
the exact reviewed bytes and digest. This readable copy adds the maturity
notice and repairs links after relocation; it is not the digest authority.
