...
for (const required of [
  ...
  "GEOMETER_JS_B64",
  "GEOMETER_WASM_B64",
  "geometry.mesh_illustration.geometry.b0",
  ...
  'id="illustrationClipMode"',
  'id="illustrationClipSide"',
  'id="illustrationClipPosition"',
  'option value="view">Camera-facing</option>',
  "geometry.model_illustration_geometry.b0",
  "cap policy is <code>none</code>",
