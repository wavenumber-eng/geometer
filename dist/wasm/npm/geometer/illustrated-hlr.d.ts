...
export interface FastHlrIllustrationRequestA0 {
    ...
    readonly hlr?: Omit<HlrProjectionOptionsA0, "views" | "projection_algorithm" | "outline_algorithm" | "model_transform" | "strip_root_placement">;
}
...
export declare function createFastHlrIllustratorA0(projector: MeshHlrProjectorA0, request: FastHlrIllustrationRequestA0): Promise<PreparedFastHlrIllustrationA0>;
/** Project Fast vector linework, colorize the mesh, and return one SVG result. */
export declare function illustrateMeshWithFastHlrA0(projector: MeshHlrProjectorA0, request: FastHlrIllustrationRequestA0): Promise<FastHlrIllustrationResultA0>;
